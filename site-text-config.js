(function initSiteTextConfig() {
    const DEFAULT_SITE_TEXT_CONFIG = {
        ...
        utilityModal: {
            title: '⋯ 보조 기능 모음',
            descriptionHtml: '연습 밖 기능만 모아 둔 공간입니다. 자세한 기준은 ?에서 확인하세요.',
            descriptionAdvancedHtml: '연습 밖 기능과 고급 보관함을 모아 둔 공간입니다. 자세한 기준은 ?에서 확인하세요.',
            statsTitle: '활성 세션 보기',
            statsDescription: '현재 열려 있는 세션과 최근 방문 기록을 확인합니다.',
            communityTitle: '커뮤니티',
            communityDescription: '공지, 질문, 후기, 개선요청을 한곳에서 확인합니다.',
            archiveTitle: '자료 보관함',
            archiveDescription: '고급 모드 전용입니다. 자료를 저장하려면 보관함 로그인으로 다시 확인합니다.',
        ...
        helpModal: {
            title: '📘 일반 모드 빠른 안내',
            exampleSectionTitle: '📷 화면 배치 예시',
            pdfTitle: '▶ PDF 활용 예시',
            pdfCaption: '좌측에 PDF나 e-book을 두고 비율만 맞춰 연습하면 됩니다.',
            omrTitle: '▶ 연습용 모드 (OMR 사용)',
            omrCaption: '정답 체크와 채점이 필요할 때만 OMR을 펼쳐 사용합니다.',
            advancedSectionTitle: '🔒 고급 설명은 따로 봅니다',
            advancedSectionLeadHtml: '이 창은 <strong>일반 모드</strong>만 설명합니다. 신청, 승인, 복기 추가 버튼, 자료 보관함은 <strong>고급 안내</strong>에서 확인하세요.',
            advancedLinkButton: '고급 안내 열기',
            ...
            featureSectionTitle: '🗺️ 일반 모드 핵심 흐름',
            sidebarFeatureHtml: '<div style="position:absolute; top:-10px; left:10px; background:#1e293b; padding:0 5px; color:#3b82f6; font-weight:bold;">왼쪽에서 여는 것</div>\n<p>📘 <strong>가이드</strong> — 일반 기준 확인</p>\n<p>📝 <strong>연습 OMR</strong> — 답 체크와 채점</p>\n<p>⚙ <strong>설정</strong> — 시간과 비율 조정</p>\n<p>🔒 <strong>고급 안내</strong> — 신청과 진입</p>\n<p>↗ <strong>팝업</strong> — 더 좁은 실전 폭</p>\n<p>⋯ <strong>더보기</strong> — 활성 세션, 커뮤니티, 문서</p>\n<hr style="border-color:#334155; margin: 8px 0;">\n<p style="color:#93c5fd;"><strong>핵심</strong>: 답 체크 → 정답 입력 모드 → 채점</p>\n<p style="color:#93c5fd;">상세 설명은 각 창의 <strong>?</strong>에서 바로 확인합니다.</p>',
            timerFeatureHtml: '<strong>🕒 다중 페이즈 타이머</strong><br>\n전체 시간과 과목 시간을 함께 확인합니다.<br>\n<span style="color:#c4b5fd;">과목 전환과 쉬는 시간은 자동으로 이어집니다.</span>',
            practiceFeatureHtml: '<strong>✏️ 연습장 (메모장 & 그림판)</strong><br>\n풀이 흔적은 문제 이동 시 정리됩니다.<br>\n<span style="color:#fde68a;">실전처럼 짧게 메모하고 바로 넘어가는 흐름입니다.</span>',
            calculatorFeatureHtml: '<strong>🧮 실전형 계산기</strong><br>\n키보드 입력과 기본 연산만 지원합니다.<br>\n<span style="color:#86efac;">복잡한 기능 없이 빠르게 계산하는 용도입니다.</span>'
        },
        settingsModal: {
            title: '⚙ 통합 설정',
        ...
        advancedGuide: {
            ...
            featureTitle: '2. 고급에서 추가되는 것',
            featureCard1Html: '<strong style="display:block; color:#0f172a; margin-bottom:4px;">실전 제어</strong>\n과목 건너뛰기, 과목 초기화, 전체 초기화가 추가됩니다.',
            featureCard2Html: '<strong style="display:block; color:#0f172a; margin-bottom:4px;">상세 복기</strong>\n상세 통계, TXT, 정오표로 복기 흐름을 짧게 만듭니다.',
            featureCard3Html: '<strong style="display:block; color:#0f172a; margin-bottom:4px;">시간 가이드</strong>\n문항별 시간 감각을 더 세밀하게 확인할 수 있습니다.',
            featureCard4Html: '<strong style="display:block; color:#0f172a; margin-bottom:4px;">자료 보관함</strong>\n고급 모드에서만 열리고, 보관함 로그인으로 다시 확인합니다.',
            featureAccessHtml: '이 창은 신청과 진입만 설명합니다. 버튼 사용 흐름은 고급 활용에서 다시 보면 됩니다.',
            planTitle: '3. 처음 신청하기',
            planIntro: '후원 확인 뒤 신청서를 저장하면 됩니다.',
            donateButton: '1. 후원 페이지 열기',
            flowHtml: '후원 확인 → 신청 저장 → 상태 확인 → 승인 후 고급 진입',
            formTitle: '4. 신청서 저장',
            formDescription: '시작일, 닉네임, 이메일, 로그인 ID, 비밀번호만 입력합니다.',
            passwordHint: '같은 비밀번호를 <strong>신청 조회</strong>와 <strong>고급 로그인</strong>에 함께 씁니다.',
            submitButton: '2. 신청 저장',
            lookupTitle: '5. 신청 상태 확인',
            lookupDescription: '조회는 신청 이메일만, 로그인은 이메일 또는 로그인 ID를 씁니다.',
            lookupButton: '상태 확인',
        ...
        advancedFeature: {
            title: '✨ 고급 모드 빠른 사용',
            introHtml: '<div style="font-weight:800; margin-bottom:6px;">고급에서 가장 많이 쓰는 버튼만 다시 확인하는 창입니다.</div>\n상단 상태, OMR 아래 복기 버튼, 더보기 안 자료 보관함만 기억하면 됩니다.',
            ...
            image1Caption: '지금 열린 권한과 만료 시각은 상단에서 바로 확인합니다. 우측 여백은 실제 환경 감각을 맞추는 용도입니다.',
            image2Title: '2. OMR 아래 복기 버튼 익히기',
            image2Caption: '정답 입력, 채점, 상세 통계, TXT, 정오표는 모두 OMR 아래에 모여 있습니다.',
            flowButton: '신청 안내 보기',
        ...
        advancedMode: {
            ...
            statusLeadHtml: '이 브라우저에 열려 있는 고급 상태를 바로 확인합니다.',
            labelState: '상태',
            labelLogin: '로그인',
            labelExpiry: '만료',
            labelArchive: '자료 보관함',
            ...
            footnoteHtml: '자료 보관함은 <strong>더보기</strong>에서 열고, 들어간 뒤에는 <strong>보관함 로그인</strong>으로 다시 확인합니다.',
            guideButton: '고급 활용',
            archiveButton: '자료 보관함 열기',
            coachTitle: '고급 복기',
            coachLeadHtml: '정답 입력 → 채점 → 복기 버튼',
            coachStep1Html: '<strong>정답 입력</strong><br>실제 정답만 넣습니다.',
            coachStep2Html: '<strong>채점</strong><br>점수와 건너뜀을 먼저 봅니다.',
            coachStep3Html: '<strong>복기 버튼</strong><br>상세 통계, TXT, 정오표로 이어갑니다.',
        ...
        messages: {
            ...
            advancedAvailable: '승인된 이메일 또는 로그인 ID와 비밀번호를 입력하면 바로 고급 모드가 열립니다.',
            ...
            manualSubmitSuccess: '신청이 저장되었습니다. 같은 이메일로 상태를 확인하고, 승인 후 이메일 또는 로그인 ID로 고급 모드를 열 수 있습니다.',
    ...
    const LEGACY_SITE_TEXT_DEFAULTS = {
        ...
        'helpModal.title': ['📖 사용 가이드', '📘 기본 사용 가이드', '📘 일반 사용 가이드'],
        'helpModal.exampleSectionTitle': ['📷 추천 배치 예시', '📷 실제 툴 사용 권장 예시'],
        ...
        'helpModal.featureSectionTitle': ['🗺️ 기능 안내', '🗺️ 일반 모드 핵심 기능'],
        ...
        'helpModal.advancedSectionTitle': ['🔒 고급 기능은 별도 버튼에서 확인', '🧭 고급 모드 활용 가이드', '🔒 고급 안내는 별도로 봅니다'],
        ...
        'advancedGuide.title': ['🔒 고급 이용 안내', '🔒 고급 기능 안내', '🔒 고급 기능', '🔒 고급 모드 신청 · 진입 안내'],
        'advancedGuide.loginTitle': ['1. 승인된 신청으로 고급 모드 열기', '1. 승인된 이용권으로 바로 열기', '1. 이미 승인된 경우 바로 열기'],
        ...
        'advancedMode.coachTitle': ['고급 버튼 빠른 설명', '고급 버튼 사용 순서', '고급 복기 순서'],
