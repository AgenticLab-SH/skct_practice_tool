(function initSiteTextConfig() {
    const DEFAULT_SITE_TEXT_CONFIG = {
        ...
        helpModal: {
            ...
            advancedSectionTitle: '🧭 고급 모드 활용 가이드',
            advancedSectionLeadHtml: '고급 모드에서는 <strong>복기 버튼</strong>, <strong>자료 보관함</strong>, <strong>실제환경 우측 여백</strong>이 함께 열립니다. 아래 두 장만 먼저 보면 어디를 눌러야 할지 빠르게 감이 잡힙니다.',
            advancedImage1Title: '1. 상단 상태 바와 우측 실제환경 여백 확인',
            advancedImage1Caption: '고급 모드가 열리면 상단 상태 바에서 로그인 ID, 만료 시각, 자료 보관함 가능 여부를 먼저 확인하고, 우측에는 실제환경처럼 버튼 자리와 여백이 복원됩니다.',
            advancedImage2Title: '2. OMR 아래 고급 버튼 안내 패널 따라가기',
            advancedImage2Caption: '정답 입력 모드, 채점, 상세 통계, 정오표 일괄입력은 OMR 아래 버튼 구역에 모여 있습니다. 새 안내 패널이 순서를 바로 설명해 줍니다.',
        ...
        advancedGuide: {
            ...
            featureAccessHtml: '<strong>접근 기준</strong><br>과목 건너뛰기, 과목 초기화, 전체 초기화, 문항별 시간 가이드, 상세 통계 다운로드, 자료 보관함은 모두 고급 모드 전용입니다. 특히 자료 보관함은 고급 라이선스가 있는 브라우저에서만 열리고, 들어간 뒤에도 로그인한 계정만 사용할 수 있습니다.',
        ...
        advancedFeature: {
            ...
            summaryHtml: '<strong>추천 흐름</strong><br>답안을 체크한 뒤 <strong>정답 입력 모드</strong>로 전환하고 정답을 넣은 다음, <strong>채점 및 통계 확인</strong>을 누르면 복기용 기능이 한 번에 열립니다.<br><br><strong>자료 보관함</strong>은 일반 모드에서 보이지 않으며, 고급 라이선스가 확인된 브라우저에서만 더보기 메뉴로 열 수 있습니다.',
            planHtml: '<strong>주로 쓰는 기능 위치</strong><br><strong>과목별 상세 통계</strong>, <strong>문항별 상세 통계 TXT 다운로드</strong>, <strong>정오표 일괄입력</strong>, <strong>과목/전체 초기화</strong>, <strong>문항별 시간 가이드</strong>는 모두 고급 모드에서 씁니다.<br><br><strong>자료 보관함</strong>은 더보기 메뉴 안의 별도 페이지이며, 고급 라이선스와 페이지 로그인 둘 다 필요합니다.',
        ...
        advancedMode: {
            ...
            guideButton: '고급 기능 다시 보기',
            archiveButton: '자료 보관함 열기',
            coachTitle: '고급 버튼 빠른 설명',
            coachLeadHtml: '정답 입력 모드로 바꾼 뒤 <strong>채점</strong>과 <strong>복기 버튼</strong>을 순서대로 쓰면 됩니다. 처음에는 이 박스 순서대로만 따라가도 충분합니다.',
            coachStep1Html: '<strong>1. 정답 입력 모드</strong><br>답안 체크가 끝나면 정답 입력 모드로 바꾸고 실제 정답을 넣습니다.',
            coachStep2Html: '<strong>2. 채점 및 과목별 통계</strong><br>채점 후 과목별 상세 통계와 TXT 다운로드로 약점을 바로 정리합니다.',
            coachStep3Html: '<strong>3. 다시 풀기 준비</strong><br>정오표 일괄입력, 과↺, 전↺, 시간 가이드를 조합해 반복 연습 속도를 높입니다.',
            coachHintHtml: '<strong>과↺</strong>는 현재 과목만 다시 시작하고, <strong>전↺</strong>는 전체 시험을 처음 상태로 되돌립니다. 자료 보관함은 더보기에서 따로 열립니다.',
            coachGuideButton: '안내 창'
        },
        archivePage: {
    ...
    const LEGACY_SITE_TEXT_DEFAULTS = {
        ...
        'helpModal.advancedSectionTitle': ['🧭 고급 모드 활용 가이드'],
        'helpModal.advancedSectionLeadHtml': ['고급 모드에서는 <strong>복기 버튼</strong>, <strong>자료 보관함</strong>, <strong>실제환경 우측 여백</strong>이 함께 열립니다. 아래 두 장만 먼저 보면 어디를 눌러야 할지 빠르게 감이 잡힙니다.'],
        'helpModal.advancedImage1Title': ['1. 상단 상태 바와 우측 실제환경 여백 확인'],
        'helpModal.advancedImage1Caption': ['고급 모드가 열리면 상단 상태 바에서 로그인 ID, 만료 시각, 자료 보관함 가능 여부를 먼저 확인하고, 우측에는 실제환경처럼 버튼 자리와 여백이 복원됩니다.'],
        'helpModal.advancedImage2Title': ['2. OMR 아래 고급 버튼 안내 패널 따라가기'],
        'helpModal.advancedImage2Caption': ['정답 입력 모드, 채점, 상세 통계, 정오표 일괄입력은 OMR 아래 버튼 구역에 모여 있습니다. 새 안내 패널이 순서를 바로 설명해 줍니다.'],
        ...
        'advancedMode.coachTitle': ['고급 버튼 빠른 설명'],
        'advancedMode.coachLeadHtml': ['정답 입력 모드로 바꾼 뒤 <strong>채점</strong>과 <strong>복기 버튼</strong>을 순서대로 쓰면 됩니다. 처음에는 이 박스 순서대로만 따라가도 충분합니다.'],
        ...
        'advancedMode.coachGuideButton': ['안내 창'],
    ...
    const SITE_TEXT_CATALOG = [
        ...
        { key: 'helpModal.advancedSectionTitle', label: '고급 가이드 섹션 제목', category: '가이드 모달', selector: '#helpAdvancedSectionTitle', prop: 'text' },
        { key: 'helpModal.advancedSectionLeadHtml', label: '고급 가이드 섹션 설명', category: '가이드 모달', selector: '#helpAdvancedSectionLead', prop: 'html', multiline: true },
        { key: 'helpModal.advancedImage1Title', label: '고급 가이드 이미지 1 제목', category: '가이드 모달', selector: '#helpAdvancedImage1Title', prop: 'text' },
        { key: 'helpModal.advancedImage1Caption', label: '고급 가이드 이미지 1 설명', category: '가이드 모달', selector: '#helpAdvancedImage1Caption', prop: 'text' },
        { key: 'helpModal.advancedImage2Title', label: '고급 가이드 이미지 2 제목', category: '가이드 모달', selector: '#helpAdvancedImage2Title', prop: 'text' },
        { key: 'helpModal.advancedImage2Caption', label: '고급 가이드 이미지 2 설명', category: '가이드 모달', selector: '#helpAdvancedImage2Caption', prop: 'text' },
        ...
        { key: 'advancedGuide.featureAccessHtml', label: '고급 안내: 접근 기준', category: '고급 안내', selector: '#advancedGuideFeatureAccess', prop: 'html', multiline: true },
        ...
        { key: 'advancedMode.guideButton', label: '고급 상태 바 안내 버튼', category: '고급 상태 바', selector: '#advancedModeGuideBtn', prop: 'text' },
        { key: 'advancedMode.archiveButton', label: '고급 상태 바 보관함 버튼', category: '고급 상태 바', selector: '#advancedModeArchiveBtn', prop: 'text' },
        { key: 'advancedMode.coachTitle', label: '고급 버튼 가이드 제목', category: '고급 버튼 가이드', selector: '#advancedCoachTitle', prop: 'text' },
        { key: 'advancedMode.coachLeadHtml', label: '고급 버튼 가이드 설명', category: '고급 버튼 가이드', selector: '#advancedCoachLead', prop: 'html', multiline: true },
        { key: 'advancedMode.coachStep1Html', label: '고급 버튼 가이드 1', category: '고급 버튼 가이드', selector: '#advancedCoachStep1', prop: 'html', multiline: true },
        { key: 'advancedMode.coachStep2Html', label: '고급 버튼 가이드 2', category: '고급 버튼 가이드', selector: '#advancedCoachStep2', prop: 'html', multiline: true },
        { key: 'advancedMode.coachStep3Html', label: '고급 버튼 가이드 3', category: '고급 버튼 가이드', selector: '#advancedCoachStep3', prop: 'html', multiline: true },
        { key: 'advancedMode.coachHintHtml', label: '고급 버튼 가이드 하단 힌트', category: '고급 버튼 가이드', selector: '#advancedCoachHint', prop: 'html', multiline: true },
        { key: 'advancedMode.coachGuideButton', label: '고급 버튼 가이드 안내 버튼', category: '고급 버튼 가이드', selector: '#advancedCoachGuideBtn', prop: 'text' },
