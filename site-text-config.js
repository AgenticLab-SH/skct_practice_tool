(function initSiteTextConfig() {
    const DEFAULT_SITE_TEXT_CONFIG = {
        ...
        helpModal: {
            title: '📘 일반 사용 가이드',
            exampleSectionTitle: '📷 추천 배치 예시',
            pdfTitle: '▶ PDF 활용 예시',
            pdfCaption: '좌측에 PDF나 e-book을 띄우고 예시와 비슷한 비율로 맞춰 연습하면 됩니다.',
            omrTitle: '▶ 연습용 모드 (OMR 사용)',
            omrCaption: '정답 마킹과 채점을 위해 OMR을 펼쳐두고 연습할 수 있습니다.',
            advancedSectionTitle: '🔒 고급 안내는 별도로 봅니다',
            advancedSectionLeadHtml: '이 창은 <strong>일반 모드</strong>와 기본 연습 흐름만 설명합니다. 신청, 승인 확인, 추가 버튼, 자료 보관함, 우측 실제환경 여백은 <strong>고급 안내</strong>와 <strong>고급 활용</strong>에서 따로 확인해 주세요.',
        ...
        messages: {
            ...
            advancedAvailable: '신청 이메일 또는 로그인 ID와 비밀번호를 입력하면 바로 고급 모드로 들어갑니다.',
    ...
    const LEGACY_SITE_TEXT_DEFAULTS = {
        ...
        'helpModal.title': ['📖 사용 가이드', '📘 기본 사용 가이드'],
        ...
        'helpModal.advancedSectionTitle': ['🔒 고급 기능은 별도 버튼에서 확인', '🧭 고급 모드 활용 가이드'],
        ...
        'advancedGuide.title': ['🔒 고급 이용 안내', '🔒 고급 기능 안내', '🔒 고급 기능'],
