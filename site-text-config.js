(function initSiteTextConfig() {
    const DEFAULT_SITE_TEXT_CONFIG = {
        ...
        settingsModal: {
            ...
            practiceModeHint: '<div><strong>기본은 실전입니다.</strong> 과목 시간이 끝나면 자동으로 잠기고 다음 과목 흐름으로 넘어갑니다.</div><div><strong>자유 풀이를 켜면</strong> 시간 제한과 강제 전환 없이 연습합니다.</div>',
            scoringTitle: '📊 건너뛴 문항',
        ...
        advancedGuide: {
            title: '🔒 고급 모드',
            loginTitle: '1. 구독 신청 때 사용한 ID와 PW로 로그인',
            loginBody: '승인된 이메일 또는 로그인 ID와 비밀번호로 고급 모드를 엽니다.',
            accessButton: '고급 모드 열기',
            accessIdPlaceholder: '구독 신청 때 사용한 이메일 ID',
            ...
            featureAccessHtml: '<strong>고급 모드에서 편해지는 것</strong><br>과목 초기화, 상세 통계, TXT 다운로드, 정오표 일괄입력, 자료 보관함을 사용할 수 있습니다.',
            planTitle: '3. 구독 요금제',
            planIntro: '이용권을 고른 뒤 후원 페이지에서 금액을 후원하고 신청서를 저장합니다. 소요시간은 10분 정도입니다.',
        ...
        messages: {
            ...
            manualRequiredFields: '후원 닉네임, 이용 시작일, 닉네임, 알림 이메일, 로그인 ID, 비밀번호를 모두 입력해 주세요.',
    ...
    const LEGACY_SITE_TEXT_DEFAULTS = {
        ...
        'advancedGuide.planTitle': ['3. 신청 방법', '3. 이용권 선택', '3. 후원 후 신청 남기기', '3. 처음 신청하는 경우', '3. 처음 신청하기'],
