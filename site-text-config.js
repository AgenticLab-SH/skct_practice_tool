(function initSiteTextConfig() {
    const DEFAULT_SITE_TEXT_CONFIG = {
        ...
        advancedFeature: {
            title: '✨ 고급 활용 가이드',
            introHtml: '<div style="font-weight:800; margin-bottom:6px;">일반 모드에 없는 기능만 모았습니다.</div>\n고급 모드에서는 <strong>복기용 버튼</strong>, <strong>자료 보관함</strong>, <strong>우측 실제환경 여백</strong>이 추가됩니다. 아래에서 어디가 달라지는지 먼저 확인하세요.',
            summaryHtml: '<strong>추천 흐름</strong><br>답안을 체크한 뒤 <strong>정답 입력 모드</strong>로 전환하고 정답을 넣은 다음, <strong>채점 및 통계 확인</strong>으로 결과를 먼저 확인하세요. 그다음 상세 통계, TXT 다운로드, 정오표 일괄입력으로 복기를 이어가면 됩니다.',
            planHtml: '<strong>먼저 볼 위치</strong><br><strong>상단 상태 바</strong>에서는 지금 열린 권한을 확인하고, <strong>OMR 아래 버튼 구역</strong>에서는 복기 기능을 사용합니다. <strong>자료 보관함</strong>은 더보기 메뉴에서 따로 엽니다.',
            image1Title: '1. 상태 바와 우측 실제환경 여백부터 확인',
            image1Caption: '상단 상태 바에서는 로그인 ID, 만료 시각, 자료 보관함 가능 여부를 바로 확인할 수 있고, 우측에는 실제환경 감각을 맞추는 버튼 자리와 여백이 함께 복원됩니다.',
            image2Title: '2. OMR 아래 복기 버튼 흐름 따라가기',
            image2Caption: '정답 입력 모드, 채점, 상세 통계, 정오표 일괄입력은 모두 OMR 아래에 모여 있습니다. 순서만 익히면 일반 모드보다 복기 속도가 크게 빨라집니다.',
        ...
        advancedMode: {
            ...
            coachTitle: '고급 버튼 사용 순서',
            coachLeadHtml: '일반 모드에는 없는 버튼만 짧게 정리했습니다. 정답 입력 후에는 아래 순서대로 쓰면 복기가 가장 빠릅니다.',
    ...
    const SITE_TEXT_CATALOG = [
        ...
        { key: 'advancedFeature.image1Title', label: '고급 기능: 이미지 1 제목', category: '고급 기능', selector: '#advancedFeatureImage1Title', prop: 'text' },
        { key: 'advancedFeature.image1Caption', label: '고급 기능: 이미지 1 설명', category: '고급 기능', selector: '#advancedFeatureImage1Caption', prop: 'text' },
        { key: 'advancedFeature.image2Title', label: '고급 기능: 이미지 2 제목', category: '고급 기능', selector: '#advancedFeatureImage2Title', prop: 'text' },
        { key: 'advancedFeature.image2Caption', label: '고급 기능: 이미지 2 설명', category: '고급 기능', selector: '#advancedFeatureImage2Caption', prop: 'text' },
