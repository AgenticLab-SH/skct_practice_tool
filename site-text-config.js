(function initSiteTextConfig() {
    const DEFAULT_SITE_TEXT_CONFIG = {
        ...
        advancedGuide: {
            ...
            featureAccessHtml: '이 창에서는 신청과 진입만 안내합니다. 기능 사용법은 고급 활용에서 확인하세요.',
            planTitle: '3. 신청 방법',
    ...
    const LEGACY_SITE_TEXT_DEFAULTS = {
        ...
        'tools.bulkImportButton': ['📥 정오표 일괄입력', '📥 정오표 한번에 넣기'],
