(function initSiteTextConfig() {
    const DEFAULT_SITE_TEXT_CONFIG = {
        ...
        statsModal: {
            title: '🔥 접속 현황',
            activeTitle: '현재 접속',
            activeHint: '열린 탭 수 기준으로 집계됩니다.',
            trendTitle: '📈 최근 7일',
            totalTitle: '🗓️ 누적 방문',
            totalHint: '하루 1회, 브라우저 단위로 집계됩니다.'
        },
        noticeModal: {
            title: '공지사항',
        ...
        helpModal: {
            ...
            advancedSectionLeadHtml: '이 안내는 <strong>일반 모드</strong> 기준입니다. 고급 모드 전용 기능은 아래 버튼에서 확인하세요.',
        ...
        settingsModal: {
            title: '⚙ 설정',
            practiceModeTitle: '🎯 모드',
            practiceModeHint: 'OFF = 실전 — 시간 종료 시 자동 잠금\nON = 연습 — 시간 제한 없이 풀기',
            scoringTitle: '📊 건너뛴 문항',
        ...
        advancedGuide: {
            title: '🔒 고급 모드',
            loginTitle: '1. 로그인',
            loginBody: '승인된 이메일 또는 로그인 ID와 비밀번호로 고급 모드에 진입합니다.',
            accessButton: '고급 모드 열기',
            accessIdPlaceholder: '이메일 또는 ID',
            accessPasswordPlaceholder: '비밀번호',
            featureTitle: '2. 고급 전용 기능',
            featureCard1Html: '<strong style="display:block; color:#0f172a; margin-bottom:4px;">실전 제어</strong>\n과목 건너뛰기·과목 초기화·전체 초기화를 사용할 수 있습니다.',
            featureCard2Html: '<strong style="display:block; color:#0f172a; margin-bottom:4px;">상세 복기</strong>\n과목별 통계, TXT 다운로드, 정오표 일괄입력으로 빠르게 복기합니다.',
            featureCard3Html: '<strong style="display:block; color:#0f172a; margin-bottom:4px;">시간 가이드</strong>\n문항별 시간 배분을 세밀하게 확인합니다.',
            featureCard4Html: '<strong style="display:block; color:#0f172a; margin-bottom:4px;">자료 보관함</strong>\n고급 모드에서만 접근 가능하며, 별도 로그인이 필요합니다.',
            featureAccessHtml: '<strong>일반 모드와의 차이</strong><br>실전 제어, 상세 복기, 시간 가이드, 자료 보관함이 고급 모드에서 열립니다. 대신 좌측 후원 버튼은 고급 모드에서는 보이지 않아 연습 흐름에만 집중할 수 있습니다.',
            planTitle: '3. 신청 방법',
            planIntro: '후원 후 신청서를 작성하면 승인을 기다리게 됩니다.',
            donateButton: '후원 페이지 열기',
            flowHtml: '후원 → 신청서 작성 → 승인 확인 → 고급 모드 진입',
            formTitle: '4. 신청서 작성',
            formDescription: '아래 항목을 작성해 주세요.',
            passwordHint: '이 비밀번호는 <strong>신청 조회</strong>와 <strong>고급 로그인</strong>에 함께 사용됩니다.',
            submitButton: '신청하기',
            lookupTitle: '5. 신청 조회',
            lookupDescription: '신청 시 입력한 이메일과 비밀번호로 승인 여부를 확인합니다.',
            lookupButton: '조회',
        ...
        advancedFeature: {
            title: '✨ 고급 활용',
            introHtml: '<div style="font-weight:800; margin-bottom:6px;">고급 모드에서 자주 쓰는 버튼 위치를 확인하는 창입니다.</div>\n상단 상태, OMR 아래 복기 버튼, 더보기 안 자료 보관함만 기억하면 됩니다.',
            summaryHtml: '<strong>정답 입력</strong> → <strong>채점</strong> → <strong>과목별 통계</strong> → <strong>TXT / 정오표</strong>',
            planHtml: '자료 보관함은 <strong>더보기</strong>에서 따로 엽니다.',
            image1Title: '1. 상단 상태 바',
            image1Caption: '로그인 ID, 만료 시각을 상단에서 확인합니다.',
            image2Title: '2. OMR 아래 복기 버튼',
            image2Caption: '정답 입력, 채점, 통계, 정오표 버튼이 모두 여기에 있습니다.',
            flowButton: '신청 안내',
            statsButton: '문항별 통계 TXT 다운로드',
            feature1Html: '<strong>1. 결과 확인</strong><br>맞은 수, 정답률, 건너뜀, 미응답을 먼저 확인합니다.',
            feature2Html: '<strong>2. 과목별 약점</strong><br>과목별 통계로 부족한 영역을 확인합니다.',
            feature3Html: '<strong>3. TXT 저장</strong><br>문항별 통계를 파일로 저장합니다.',
            feature4Html: '<strong>4. 반복 연습</strong><br>정오표, 과↺, 전↺, 시간 가이드로 다시 풉니다.'
        },
        advancedMode: {
            statusTitle: '고급 모드',
            statusLeadHtml: '현재 상태를 확인합니다.',
            labelState: '상태',
            labelLogin: '로그인',
            labelExpiry: '만료',
            labelArchive: '자료 보관함',
            ...
            footnoteHtml: '자료 보관함은 <strong>더보기</strong>에서 열 수 있으며, 별도 로그인이 필요합니다.',
            guideButton: '활용 안내',
            archiveButton: '보관함 열기',
            coachTitle: '복기 흐름',
            coachLeadHtml: '정답 입력 → 채점 → 통계·TXT·정오표',
            coachStep1Html: '<strong>정답 입력</strong><br>실제 정답만 넣습니다.',
            coachStep2Html: '<strong>채점</strong><br>점수와 건너뜀을 먼저 확인합니다.',
            coachStep3Html: '<strong>복기</strong><br>통계, TXT, 정오표로 이어갑니다.',
            coachHintHtml: '<strong>과↺</strong>는 현재 과목만, <strong>전↺</strong>는 전체를 다시 시작합니다.',
            coachGuideButton: '자세히 보기'
        },
        archivePage: {
            metaTitle: '개인 학습자료 보관함 | SKCT Tool',
            metaDescription: '고급 모드 이용자를 위한 개인 학습자료 보관함입니다. 문제 원문, AI 응답, 복기 메모를 계정별로 저장합니다.',
            heroEyebrow: 'Advanced Study Library',
            heroTitle: '개인 학습자료 보관함',
            heroCopyHtml: '고급 모드 전용 보관함입니다. 로그인 후 문제 원문, AI 응답, 복기 메모를 계정별로 저장하고 다시 확인할 수 있습니다.',
            backButton: '메인으로',
            ...
            authLoginTitle: '내 자료 로그인',
            authLoginDescription: '보관함 계정으로 로그인하면 자료를 관리할 수 있습니다.',
            authRegisterTitle: '보관함 계정 만들기',
            authRegisterDescription: '처음이라면 이메일과 비밀번호로 계정을 만들어 주세요.',
            authLoginButton: '로그인',
            authRegisterButton: '가입',
            authFootnoteHtml: '세션은 브라우저를 닫으면 종료됩니다. 고급 라이선스 확인 후에만 로그인 화면이 열립니다.',
            workspaceTitle: '내 보관함',
            workspaceCopyHtml: '입력 폼에서 저장하고, 목록에서 필터링하며, 상세 패널에서 복기 내용을 확인합니다.',
            logoutButton: '로그아웃'
        },
        messages: {
            advancedLoading: '고급 모드 정보를 확인하는 중…',
            advancedCooldown: '로그인 정보를 여러 번 틀렸습니다. {seconds}초 후 다시 시도해 주세요.',
            advancedUnlocked: '저장된 인증으로 바로 고급 모드를 열 수 있습니다. (만료: {expiry})',
            advancedAvailable: '이메일 또는 ID와 비밀번호를 입력해 주세요.',
            ...
            advancedReuse: '저장된 인증으로 고급 모드를 다시 엽니다.',
            archiveAccessChecking: '고급 모드 인증을 확인하는 중…',
            archiveAccessDenied: '자료 보관함은 고급 모드 전용입니다. 메인 화면에서 고급 모드를 먼저 열어 주세요.',
    ...
    const LEGACY_SITE_TEXT_DEFAULTS = {
        ...
        'toolbar.popupButton': ['화면 더 줄이기', '팝업 연습'],
        ...
        'helpModal.featureSectionTitle': ['🗺️ 기능 안내', '🗺️ 일반 모드 핵심 기능', '🗺️ 일반 모드 핵심 흐름'],
        ...
        'helpModal.advancedSectionLeadHtml': [
            '이 가이드는 <strong>일반 모드 기준</strong>으로 정리되어 있습니다. 복기용 추가 버튼, 자료 보관함, 우측 실제환경 여백처럼 고급 모드에서만 열리는 기능은 좌측 <strong>고급 기능</strong> 버튼에서 따로 확인해 주세요.',
        ...
        'advancedGuide.loginTitle': ['1. 승인된 신청으로 고급 모드 열기', '1. 승인된 이용권으로 바로 열기', '1. 이미 승인된 경우 바로 열기', '1. 승인된 경우 바로 열기'],
        ...
        'advancedGuide.featureTitle': ['2. 고급 모드 전용 기능', '2. 일반 모드에 추가로 열리는 기능', '2. 고급에서 추가되는 것'],
        'advancedGuide.featureCard1Html': ['<strong style="display:block; color:#0f172a; margin-bottom:4px;">실전 제어 확장</strong>\n과목 건너뛰기, 과목 초기화, 전체 초기화로 반복 연습과 실전 전환 속도를 높입니다.', '<strong style="display:block; color:#0f172a; margin-bottom:4px;">실전 제어 확장</strong>\n과목 건너뛰기, 과목 초기화, 전체 초기화로 반복 연습 전환이 빨라집니다.'],
        'advancedGuide.featureCard2Html': ['<strong style="display:block; color:#0f172a; margin-bottom:4px;">상세 복기 정리</strong>\n과목별 상세 통계, 문항별 상세 통계 TXT 다운로드, 정오표 일괄입력으로 복기 흐름을 짧게 만듭니다.', '<strong style="display:block; color:#0f172a; margin-bottom:4px;">상세 복기 기능</strong>\n과목별 상세 통계, TXT 다운로드, 정오표 일괄입력으로 복기를 짧게 이어갑니다.'],
        'advancedGuide.featureCard3Html': ['<strong style="display:block; color:#0f172a; margin-bottom:4px;">시간 감각 훈련</strong>\n문항별 시간 가이드와 기록으로 어느 구간에서 시간이 밀리는지 더 세밀하게 확인합니다.', '<strong style="display:block; color:#0f172a; margin-bottom:4px;">시간 감각 확인</strong>\n문항별 시간 가이드와 기록으로 시간이 밀린 구간을 더 쉽게 찾습니다.'],
        'advancedGuide.featureCard4Html': ['<strong style="display:block; color:#0f172a; margin-bottom:4px;">개인 자료 보관함</strong>\n자료 보관함은 고급 모드에서만 보이며, 페이지 안에서 다시 로그인한 계정만 자기 자료를 읽고 수정할 수 있습니다.', '<strong style="display:block; color:#0f172a; margin-bottom:4px;">개인 자료 보관함</strong>\n고급 모드에서만 보이며, 페이지 안에서 다시 로그인한 계정만 자기 자료를 읽고 수정할 수 있습니다.'],
        'advancedGuide.featureAccessHtml': [
            '<strong>일반 모드와의 차이</strong><br>실전 제어, 상세 복기, 시간 가이드, 자료 보관함이 고급 모드에서 열립니다. 대신 좌측 후원 버튼은 고급 모드에서는 보이지 않아 연습 흐름에만 집중할 수 있습니다.',
        ...
        'advancedGuide.planTitle': ['3. 이용권 선택', '3. 후원 후 신청 남기기', '3. 처음 신청하는 경우', '3. 처음 신청하기'],
        'advancedGuide.planIntro': [
            ...
            '후원 확인 -> 신청 저장 -> 상태 확인 -> 고급 진입 순서입니다.'
        ],
        'advancedGuide.donateButton': ['후원 페이지 열기', '1. 후원 페이지 열기'],
        ...
        'advancedGuide.formTitle': ['4. 이용권 신청서', '4. 신청 정보 저장', '4. 신청서 저장'],
        'advancedGuide.formDescription': [
            ...
            '시작일, 닉네임, 이메일, 로그인 ID, 비밀번호만 입력하면 됩니다.'
        ],
        'advancedGuide.passwordHint': [
            ...
            '비밀번호는 <strong>신청 상태 확인</strong>과 <strong>고급 모드 로그인</strong>에 모두 같은 값을 씁니다. 신청번호를 따로 기억할 필요 없이, 신청 이메일과 로그인 ID만 기억하면 됩니다.',
            '같은 비밀번호를 <strong>신청 조회</strong>와 <strong>고급 로그인</strong>에 함께 씁니다. 신청번호를 기억할 필요는 없습니다.'
        ],
        'advancedGuide.submitButton': ['신청서 저장', '2. 신청 저장'],
        ...
        'advancedMode.guideButton': ['고급 기능 다시 보기', '고급 활용 보기'],
        'advancedMode.archiveButton': ['자료 보관함 열기'],
        'advancedMode.coachTitle': ['고급 버튼 빠른 설명', '고급 버튼 사용 순서', '고급 복기 순서', '고급 복기'],
        'advancedMode.coachLeadHtml': ['정답 입력 모드로 바꾼 뒤 <strong>채점</strong>과 <strong>복기 버튼</strong>을 순서대로 쓰면 됩니다. 처음에는 이 박스 순서대로만 따라가도 충분합니다.', '일반 모드에는 없는 버튼만 짧게 정리했습니다. 정답 입력 후에는 아래 순서대로 쓰면 복기가 가장 빠릅니다.', '처음에는 아래 세 줄만 기억하면 됩니다.'],
        'advancedMode.coachStep1Html': ['<strong>1. 정답 입력 모드</strong><br>답안 체크가 끝나면 정답 입력 모드로 바꾸고 실제 정답을 넣습니다.', '<strong>1. 정답 입력</strong><br>답안 체크 뒤 실제 정답만 넣습니다.'],
        'advancedMode.coachStep2Html': ['<strong>2. 채점 및 과목별 통계</strong><br>채점 후 과목별 상세 통계와 TXT 다운로드로 약점을 바로 정리합니다.', '<strong>2. 채점 확인</strong><br>맞은 수와 정답률을 먼저 봅니다.'],
        'advancedMode.coachStep3Html': ['<strong>3. 다시 풀기 준비</strong><br>정오표 일괄입력, 과↺, 전↺, 시간 가이드를 조합해 반복 연습 속도를 높입니다.', '<strong>3. 복기 버튼</strong><br>상세 통계, TXT, 정오표로 이어갑니다.'],
        'advancedMode.coachHintHtml': ['<strong>과↺</strong>는 현재 과목만 다시 시작하고, <strong>전↺</strong>는 전체 시험을 처음 상태로 되돌립니다. 자료 보관함은 더보기에서 따로 열립니다.', '<strong>과↺</strong>는 현재 과목만, <strong>전↺</strong>는 전체 시험을 다시 시작합니다. 자료 보관함은 더보기에서 엽니다.'],
        'advancedMode.coachGuideButton': ['안내 창', '고급 활용', '전체 안내'],
        ...
        'advancedFeature.image1Caption': ['상단 상태 바에서는 로그인 ID, 만료 시각, 자료 보관함 가능 여부를 바로 확인할 수 있고, 우측에는 실제환경 감각을 맞추는 버튼 자리와 여백이 함께 복원됩니다.', '지금 열린 권한, 로그인 ID, 만료 시각은 상단에서 바로 확인합니다. 우측 여백은 실제 환경 감각을 맞추는 용도입니다.'],
        'advancedFeature.image2Title': ['2. OMR 아래 복기 버튼 흐름 따라가기'],
        'advancedFeature.image2Caption': ['정답 입력 모드, 채점, 상세 통계, 정오표 일괄입력은 모두 OMR 아래에 모여 있습니다. 순서만 익히면 일반 모드보다 복기 속도가 크게 빨라집니다.', '정답 입력, 채점, 상세 통계, TXT 다운로드, 정오표 일괄입력은 모두 OMR 아래에 모여 있습니다. 이 구역만 익히면 복기 속도가 빨라집니다.'],
        ...
        'messages.advancedAvailable': [
            '신청 이메일 또는 승인 ID와 비밀번호를 입력하면 고급 팝업을 열고, 같은 브라우저에서 자료 보관함 접근도 함께 사용할 수 있습니다.',
            '신청 이메일 또는 로그인 ID와 비밀번호를 입력하면 고급 팝업을 열고, 같은 브라우저에서 자료 보관함 접근도 함께 사용할 수 있습니다.',
            '신청 이메일 또는 로그인 ID와 비밀번호를 입력하면 바로 고급 모드로 들어갑니다.'
        ],
        ...
        'messages.manualSubmitSuccess': ['신청서가 저장되었습니다. 신청 이메일과 비밀번호로 상태를 다시 확인할 수 있습니다.', '신청서가 저장되었습니다. 상태 확인은 신청 이메일로, 고급 로그인은 승인 후 이메일 또는 로그인 ID로 진행할 수 있습니다.'],
        ...
        'statsModal.trendTitle': ['📈 최근 7일 방문 기록', '📈 최근 7일 추이'],
        'statsModal.totalTitle': ['🗓️ 누적 방문 기록', '🗓️ 전체 누적 방문'],
        'statsModal.totalHint': ['브라우저 기준 방문 기록으로 집계됩니다.', '하루에 한 번씩, 브라우저 단위로 집계됩니다.'],
        'helpModal.pdfTitle': ['▶ PDF 활용 예시', 'PDF와 함께 쓰기'],
        'helpModal.omrTitle': ['▶ 연습용 모드 (OMR 사용)', 'OMR과 함께 쓰기'],
        'settingsModal.title': ['⚙ 통합 설정'],
        'settingsModal.practiceModeTitle': ['🎯 모드 설정', '🎯 연습 모드'],
        ...
        'advancedGuide.accessIdPlaceholder': ['승인 이메일 또는 발급 ID', '신청 이메일 또는 로그인 ID'],
        'advancedMode.statusTitle': ['고급 모드 상태'],
        'advancedMode.statusLeadHtml': ['이 브라우저에서 현재 어떤 <strong>고급 기능</strong>이 열려 있는지 바로 확인할 수 있습니다.', '현재 브라우저의 고급 모드 상태입니다.'],
        'advancedMode.labelRail': ['우측 실제환경 여백'],
        'advancedMode.guideButton': ['고급 기능 다시 보기', '고급 활용 보기', '고급 활용'],
        'advancedMode.archiveButton': ['자료 보관함 열기'],
        'advancedMode.coachTitle': ['고급 버튼 빠른 설명', '고급 버튼 사용 순서', '고급 복기 순서', '고급 복기', '복기 순서'],
        'advancedMode.coachGuideButton': ['안내 창', '고급 활용', '전체 안내'],
    };
